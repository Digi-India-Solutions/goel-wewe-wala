...
const AllProduct = () => {
    ...
    const handleDelete = async (productId) => {
        try {
            ...
            if (result.isConfirmed) {
                const response = await axios.delete(`https://api.goelmewewale.com/api/delete-product/${productId}`);
    ...
    const handleStatusChange = async (productId, field, currentValue) => {
        try {
            const response = await axios.put(`https://api.goelmewewale.com/api/update-product/${productId}`, {
