...
const EditPincode = () => {
    ...
    useEffect(() => {
        ...
        const fetchPincodeDetails = async () => {
            try {
                const response = await axios.get(`https://api.goelmewewale.com/api/single-pincode/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.goelmewewale.com/api/update-pincode/${id}`, pincodeData);
