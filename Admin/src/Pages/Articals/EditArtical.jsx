...
const EditArtical = () => {
    ...
    useEffect(() => {
        const fetchArticalData = async () => {
            try {
                const response = await axios.get(`https://api.goelmewewale.com/api/single-artical/${id}`);
                setData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.goelmewewale.com/api/update-artical/${id}`, formData, {
                headers: {
