...
const AllContactInquery = () => {
    ...
    useEffect(() => {
        const fetchContacts = async () => {
            try {
                const response = await axios.get('https://api.goelmewewale.com/api/all-contacts');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://api.goelmewewale.com/api/delete-contact/${id}`);
