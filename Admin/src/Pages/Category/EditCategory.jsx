...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`https://api.goelmewewale.com/api/signle-category/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.goelmewewale.com/api/update-category/${id}`, formData, {
                headers: {
