      ...
      <header>
        <div className="top-head">
          ...
          >
            ...
            />
            <h2>Goel Mewe Wale Admin Panel</h2>
            <div
              className="bar"
        ...
        <div className={`rightNav ${sidetoggle ? "active" : ""} `}>
          <ul>
            ...
            <li
              className={
                isActive("/all-orders") || isActive("/edit-order")
                  ? "active"
                  : ""
              }
            >
              <Link to="/all-orders" onClick={handletoggleBtn}>
                {" "}
                <i class="fa-solid fa-cart-shopping"></i> Manage Orders
              </Link>
            </li>
            <li className={isActive("/all-contact-inquery") ? "active" : ""}>
              <Link to="/all-contact-inquery" onClick={handletoggleBtn}>
                {" "}
                <i class="fa-solid fa-comment-dots"></i> Manage Inquery
              </Link>
            </li>
            <li
              className={
                isActive("/all-banners") ||
                isActive("/add-banner") ||
                isActive("/edit-banner")
                  ? "active"
                  : ""
              }
            >
              <Link to="/all-banners" onClick={handletoggleBtn}>
                {" "}
                <i class="fa-regular fa-images"></i> Manage Banners
              </Link>
            </li>
            <li
              className={
            ...
            >
              <Link to="/all-products" onClick={handletoggleBtn}>
                {" "}
                <i class="fa-solid fa-box"></i> Manage Product
              </Link>
            </li>
            <li
              className={
                isActive("/all-articals") ||
                isActive("/add-artical") ||
                isActive("/edit-artical")
                  ? "active"
                  : ""
              }
            >
              <Link to="/all-articals" onClick={handletoggleBtn}>
                {" "}
                <i class="fa-solid fa-box"></i> Manage Articals
              </Link>
            </li>
            <li
              className={
                isActive("/all-vouchers") ||
                isActive("/add-vouchers") ||
                isActive("/edit-vouchers")
                  ? "active"
                  : ""
              }
            >
