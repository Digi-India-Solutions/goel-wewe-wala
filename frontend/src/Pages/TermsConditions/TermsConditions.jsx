  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read the Terms and Conditions of using Goel Mewe Wale's platform, including policies on products, shipping, returns, and user conduct."
        />
      </Helmet>
      ...
      <section className="terms-section">
        ...
        <div className="container">
          <div className="terms-content">
            ...
            <p>
              Welcome to Goel Mewe Wale! By accessing and using our website (the "Site") or purchasing products from us, you agree to be bound by the following terms and conditions ("Terms"). Please read them carefully.
            </p>
            ...
            <p>
              This Site is owned and operated by Goel Mewe Wale ("we", "us", "our"). These Terms apply to all users of the Site, including without limitation users who are browsers, customers, and merchants.
            </p>
            ...
            <p>
              We deliver across India via trusted courier partners. Estimated delivery time is 3-7 business days, depending on location. Delivery charges (if any) will be mentioned at checkout. Goel Mewe Wale is not responsible for delays caused by courier companies or unforeseen circumstances.
            </p>
            ...
            <p>
              All content on this Site — including logos, text, images, graphics, and product descriptions — is the property of Goel Mewe Wale and protected under copyright laws. You may not use, reproduce, or distribute our content without written permission.
            </p>
            ...
            <p>
              We strive to provide accurate information and high-quality products; however, we do not guarantee that the Site will be error-free or uninterrupted. In no case shall Goel Mewe Wale be liable for any loss or damage arising from your use of our products or services.
            </p>
